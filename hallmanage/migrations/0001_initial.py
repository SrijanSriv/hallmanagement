# Generated by Django 4.0.5 on 2023-04-24 10:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_type', models.TextField(blank=True, choices=[('old', 'old'), ('new', 'new')], max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_password', models.CharField(default='user', max_length=50)),
                ('hall_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hallmanage.hall')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hall', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hallmanage.hall')),
